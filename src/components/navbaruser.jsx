                ...
                <div className="navbar">
                    <div className="container-xl">
                        <ul className="navbar-nav">
                            ...
                            <li onClick={() => setActiveLink(1)} className={"nav-item " + (activeLink === 1 ? 'active' : '')}  >
                            ...
                            {/* 
                            <li onClick={() => setActiveLink(2)} className={"nav-item " + (activeLink === 2 ? 'active' : '')}  >
                            ...
                            <li onClick={() => setActiveLink(3)} className="nav-item dropdown">
                            ...
                            <div className="nav-item dropdown">
                                <a href="#" className="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                    ...
                                    <div className="d-none d-xl-block ps-2">
                                        <div>Paweł Kuna</div>
                                        <div className="mt-1 small text-secondary">User</div>
                                    </div>
                                </a>
