...
import { fetchAllUser } from "../../services/users.service";
import ModalConfirm from "./ModalTableUser/ModalConfirm";
...
export const ListUser = (props) => {
    ...
    const handleDeleteUser = (users) => {
        ...
        setDataUserDelete(users);
    }

    const handleDeleteTableFromModal = (users) => {
        let cloneListUsers = _.cloneDeep(listUsers);
        cloneListUsers = cloneListUsers.filter(item => item.userId !== users.userId);
    ...
    console.log("<<<Check listdata: ", listUsers);
    return (<>
